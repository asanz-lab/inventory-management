            ...
            <tbody>
              <tr v-for="order in submittedOrders" :key="order.id">
                ...
                <td class="col-lead-time">
                  <span class="badge info">{{ order.lead_time_days }} days</span>
                </td>
...
export default {
  ...
  setup() {
    ...
    // Split the orders list so restock orders ("Submitted") render in their own
    // section above the customer orders table.
